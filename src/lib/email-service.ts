    ...
    try {
      ...
      if (!this.isInitialized) {
        ...
        return false
             ...
             const msg = {
         to: emailData.to,
         from: process.env.SENDGRID_FROM_EMAIL || 'noreply@tradeaxis.com',
    ...
    return `
      ...
      <body>
        <div class="container">
          ...
          <div class="footer">
            <p>This is an automated notification from TradeAxis Trading Platform</p>
            <p>© 2024 TradeAxis. All rights reserved.</p>
          </div>
        </div>
      </body>
      </html>
...
---
This is an automated notification from TradeAxis Trading Platform
© 2024 TradeAxis. All rights reserved.
    `.trim()
  }
