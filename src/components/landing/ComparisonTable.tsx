...
const features = [
  ...
  },
  {
    ...
    tradeAxis: 'Automated protection',
    ...
    <div className={`w-full ${className}`}>
          ...
          >
            ...
            <div className="text-center">
              <div className="flex items-center justify-center space-x-2">
                ...
                <span className="text-green-400 font-medium">{feature.tradeAxis}</span>
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
        ...
        >
          ...
          <p className="text-green-300">TradeAxis leads in 8/8 categories</p>
        </motion.div>
