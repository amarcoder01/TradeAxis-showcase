        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              <TradeAxisLogo size="md" variant="minimal" className="text-white" />
            </div>
            ...
            <div className="space-y-2 text-xs text-slate-400">
              <p className="flex items-center">
                ...
                TradeAxis Pty Ltd (ACN 685 187 679)
              </p>
              <p className="flex items-center">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-center md:text-left">
              <p className="text-sm text-slate-400">
                © {currentYear} <span className="font-medium text-white">{process.env.NEXT_PUBLIC_APP_NAME ?? 'TradeAxis Trading Platform'}</span>. All rights reserved.
              </p>
