...
import { TradeAxisLogo } from '@/components/ui/TradeAxisLogo'
...
const SidePop = () => {
  ...
  useEffect(() => {
    try {
      const dismissed = localStorage.getItem('tradeaxis_sidepop_dismissed') === '1'
      if (dismissed) return
    } catch (e) {}
  ...
  const dismiss = () => {
    setOpen(false)
    try { localStorage.setItem('tradeaxis_sidepop_dismissed', '1') } catch (e) {}
  }
            ...
            <CardContent className="p-4">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-sm text-gray-300">Follow TradeAxis Pulse on Telegram for instant signals and updates.</div>
                  <div className="mt-3 flex gap-2">
                    <a href="https://t.me/TradeAxisPulse_bot" target="_blank" rel="noopener noreferrer">
    ...
    <div className="max-w-7xl mx-auto text-center">
      ...
      >
        <div className="flex justify-center mb-6">
          <TradeAxisLogo className="h-16 w-auto text-white" />
        </div>
      ...
      >
        ...
        <a
          href="https://t.me/TradeAxisPulse_bot"
          target="_blank"
        ...
        >
          <Button
            ...
            size="lg"
            className="bg-transparent border-2 border-white/20 text-white hover:bg-white/10 focus-visible:ring-white/40 focus-visible:ring-offset-0 px-8 py-4 text-lg font-semibold rounded-xl backdrop-blur-sm transition-all duration-300"
            aria-label="Follow TradeAxis Pulse on Telegram"
          >
            Follow on Telegram
          ...
          <CardContent className="p-6 md:p-8">
            <div className="flex flex-col md:flex-row items-center md:items-center md:justify-between gap-6">
              <div className="flex items-center gap-4 text-left">
                ...
                <div>
                  <div className="text-white text-2xl font-semibold">Follow TradeAxis Pulse</div>
                  <div className="text-gray-300">@TradeAxisPulse_bot • Real-time updates in your pocket</div>
                </div>
              </div>
              <div>
                <a
      ...
      >
        ...
        <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-8 shadow-2xl border border-white/10">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="text-white/60 text-sm">TradeAxis Trading Platform</div>
                </div>
  ...
  const testimonials = [
    {
      ...
      company: '',
      content: 'TradeAxis has revolutionized my trading. The AI insights are incredibly accurate and the real-time data is unmatched.',
      rating: 5
    },
    {
      name: '',
    ...
    <section className="py-20 px-4 bg-black/20 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Join thousands of successful traders who trust TradeAxis with their investments.
          </p>
        </motion.div>
    ...
    <div className="max-w-4xl mx-auto text-center">
      ...
      >
        ...
        <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
          Join thousands of traders who are already experiencing the future of trading with TradeAxis.
        </p>
        <Button
          onClick={onOpenRegister}
          size="lg"
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-black/20 backdrop-blur-md border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <TradeAxisLogo className="h-8 w-auto text-white" />
            <div className="flex items-center space-x-4">
